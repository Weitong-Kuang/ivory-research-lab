...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.feature.substrate.title': 'Substrate Independence',
    'home.feature.substrate.desc': 'Decoupling consciousness from biological hardware through neural mapping.',
    'home.feature.personality.title': 'Personality Replication',
    'home.feature.personality.desc': 'High-fidelity digital reconstruction of behavioral and cognitive patterns.',
    'home.feature.secure.title': 'Secure Archiving',
    'home.feature.secure.desc': 'Encrypted, decentralized storage for long-term digital preservation.',
    'home.ongoing.title': 'Neural Mapping Efficiency.',
    'home.ongoing.desc': 'Our latest mapping protocol has achieved a 40% reduction in cognitive latency during digital reconstruction.',
    'home.researchers.active': '12 Researchers Active',
    'home.network.title': 'Global Network',
    'home.network.desc': 'Join our decentralized node network to help process substrate data.',
    'home.network.cta': 'Connect Node',
  },
  zh: {
    'nav.home': '首页',
    'nav.research': '研究',
    ...
    'about.why': '为什么这样做',
    'about.what': '你在做什么',
    'home.feature.substrate.title': '基质独立性',
    'home.feature.substrate.desc': '通过神经映射将意识与生物硬件解耦。',
    'home.feature.personality.title': '人格复制',
    'home.feature.personality.desc': '行为和认知模式的高保真数字重建。',
    'home.feature.secure.title': '安全存档',
    'home.feature.secure.desc': '用于长期数字保存的加密、去中心化存储。',
    'home.ongoing.title': '神经映射效率',
    'home.ongoing.desc': '我们最新的映射协议在数字重建过程中实现了 40% 的认知延迟降低。',
    'home.researchers.active': '12 位研究员活跃中',
    'home.network.title': '全球网络',
    'home.network.desc': '加入我们的去中心化节点网络，帮助处理基质数据。',
    'home.network.cta': '连接节点',
  }
};
